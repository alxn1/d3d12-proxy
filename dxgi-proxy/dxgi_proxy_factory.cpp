...
IDXGIObject *Factory::getObject() const noexcept
{
	if(object) {
		return object.get();
	} else if(factory) {
...
IDXGIFactory *Factory::getFactory() const noexcept
{
	if(factory) {
		return factory.get();
	} else if(factory1) {
...
IDXGIFactory1 *Factory::getFactory1() const noexcept
{
	if(factory1) {
		return factory1.get();
	} else if(factory2) {
...
IDXGIFactory2 *Factory::getFactory2() const noexcept
{
	if(factory2) {
		return factory2.get();
	} else if(factory3) {
...
IDXGIFactory3 *Factory::getFactory3() const noexcept
{
	if(factory3) {
		return factory3.get();
	} else if(factory4) {
...
IDXGIFactory4 *Factory::getFactory4() const noexcept
{
	if(factory4) {
		return factory4.get();
	} else if(factory5) {
...
IDXGIFactory5 *Factory::getFactory5() const noexcept
{
	if(factory5) {
		return factory5.get();
	} else if(factory6) {
...
IDXGIFactory6 *Factory::getFactory6() const noexcept
{
	if(factory6) {
		return factory6.get();
	} else {
...
IDXGIFactory7 *Factory::getFactory7() const noexcept
{
	return factory7.get();
}
